...
import { nearestFridayISO, nearestThursdayISO } from '../utils/payScheduleAnchors';
...
export const defaultFinanceState = (): FinanceState => ({
  ...
  income: {
    ...
    husbandPayAnchor: nearestFridayISO(),
    wifePayAutoLog: true,
    wifeBiweeklyPayAnchor: nearestThursdayISO(),
  },
  essentials: [
    { id: 'net', name: 'Internet', amount: 114, cadence: 'month' },
    { id: 'efl', name: 'EFL Electricity', amount: 110, cadence: 'month' },
  ...
  /** From former 12% × combined pay — now explicit dollars for the donut & remainder math. */
  plannedSavingsMonthly: 408,
  /** From former 9% × combined pay. */
  plannedPersonalMonthly: 306,
  billsPaid: {},
  billPaidAmounts: {},
  billsAutoUnmarked: {},
  incomeLog: [],

...
export function DebtPaymentHistoryModal({
  ...
  return (
    ...
    >
      <div className="bill-confirm-panel-in flex max-h-[85vh] w-full max-w-lg flex-col rounded-2xl border border-sage-200/90 bg-white p-6 shadow-2xl dark:border-moss-border dark:bg-moss-elevated">

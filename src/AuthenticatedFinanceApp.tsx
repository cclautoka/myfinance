          ...
          >
            ...
            >
              <div className="relative isolate flex min-w-0 flex-col gap-10 lg:block">
                <div className="order-3 flex min-w-0 flex-col gap-8 lg:order-none lg:ml-[calc((100%-4rem)*3/12+0.5rem)] lg:mr-[calc((100%-4rem)*3/12+0.5rem)] lg:w-[calc((100%-4rem)*6/12+1rem)] lg:max-w-[58rem]">
